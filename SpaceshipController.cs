...
public class SpaceshipController : MonoBehaviour {
    ...
    [SerializeField]
    private float m_RollEffect = 0.2f;             // The strength of effect for roll input.
    [SerializeField]
    private float m_PitchEffect = 0.2f;            // The strength of effect for pitch input.
    [SerializeField]
    private float m_YawEffect = 0.02f;            // The strength of effect for yaw input.
    [SerializeField]
